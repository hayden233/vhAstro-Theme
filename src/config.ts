export default {
  ...
  // 网站描述
  Description: 'Hayden的博客 专注于前端开发与相关技术的实战分享，涵盖Vue框架、Node.js、Serverless等，并涉及Node、Python、Linux、Docker等领域。同时，博客也分享作者的生活、音乐和旅行的热爱。',
  // 网站作者
  Author: 'Hayden',
  // 作者头像
  Avatar: 'https://q1.qlogo.cn/g?b=qq&nk=2895612785&s=640',
  // 网站座右铭
  Motto: '运气是计划之外的东西.',
  // Cover 网站缩略图
